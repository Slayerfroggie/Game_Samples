local play = {
    assets = {
        ...
        spawn = love.audio.newSource("Player_Spawn.wav", "static"),
        died = love.audio.newSource("Ball_Hit.wav", "static"),
        ball = love.audio.newSource("Ball_Spawn.wav", "static")
    },
    balls = {},
    player = {
        x = 0,
...
function play:draw()
    ...
    -- IMPORTANT TO COMMENT ON WHAT IS BEING DRAWN
